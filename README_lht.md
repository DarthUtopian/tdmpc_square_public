...
## Notice
Haotian: This is a customized repository for advanced MBRL development. Major changes are made in `tdmpc2` part, please follow the original README instruction to setup experiment env. Setup TDMPC2 related contents to meet the minial requirement.

Please create a new branch `dev/<name>` and proceed modification.
...
```
CUDA_VISIBLE_DEVICES=1 python -m tdmpc2.train disable_wandb=False wandb_entity=summer_research exp_name=baseline_H10_2M task=humanoid_h1hand-run-v0 seed=0
CUDA_VISIBLE_DEVICES=1 python -m tdmpc2.train disable_wandb=False wandb_entity=summer_research exp_name=residual_actdim task=humanoid_h1hand-slide-v0 seed=1
...
CUDA_VISIBLE_DEVICES=6 python -m tdmpc2.train disable_wandb=False wandb_entity=401910710-university-of-california-berkeley exp_name=residual_new task=quadruped-walk seed=0
```
